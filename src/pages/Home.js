    ...
    return (
      <div className="Home">
        <Paper className={classes.paper}>
          ...
          <div> <br/>
          <h3>Rules:</h3>
          {`1) Guesses must only contain alphanumeric characters (. - ' are also allowed). Guess one word/number at a time.`}
          </div>
          {`2) Guess length must be <=30 characters.`}
          <br/>
          {`3) Article names exist on Wikipedia. Excerpts of the article is provided (excerpts are not always contiguous)`}
          <br/>
          {`4) The puzzle name is related to the article name. Some may have hints at the cost of a few points.`}
          <br /> <br/>
