...
Gemini is prominent in the winter skies of the northern Hemisphere and is visible the entire night in December to January. The easiest way to locate the constellation is to find its two brightest stars Castor and Pollux eastward from the familiar V - shaped asterism (the open cluster Hyades) of Taurus and the three stars of Orion's Belt (Alnitak, Alnilam, and Mintaka). Another way is to mentally draw a line from the Pleiades star cluster located in Taurus and the brightest star in Leo, Regulus. In doing so, an imaginary line that is relatively close to the ecliptic is drawn, a line which intersects Gemini roughly at the midpoint of the constellation, just below Castor and Pollux.
...
The animal populace of the poorly run Manor Farm near Willingdon, England, is ripened for rebellion by neglect at the hands of the irresponsible and alcoholic farmer Mr. Jones. One night, the exalted boar Old Major holds a conference, at which he calls for the overthrow of humans and teaches the animals a revolutionary song called "Beasts of England". When Old Major dies, two young adult boars, Snowball and Napoleon, assume command and stage a revolt, driving out Mr. Jones and renaming the property "Animal Farm". The animals adopt the Seven Commandments of Animalism, the most important of which is "All animals are equal". These rules are painted in large letters on one side of the barn. Snowball teaches the animals to read and write, while Napoleon educates young puppies on the principles of Animalism. To commemorate the start of Animal Farm, Snowball raises a green flag made from Mrs. Jones' tablecloth with a white hoof and horn symbol. Later, Old Major's skull is exhumed and put on display. Food is plentiful, and the farm runs smoothly. The pigs elevate themselves to positions of leadership and set aside special food items, ostensibly for their health. Following an unsuccessful attempt by Mr. Jones and his associates to retake the farm, henceforth referred to by the animals as the "Battle of the Cowshed", Snowball announces his plans to modernise the farm by building a windmill. Napoleon disputes this idea, and matters come to a head, which culminates in Napoleon's dogs chasing Snowball away and Napoleon effectively assuming supreme command.

Napoleon enacts changes to the political structure of the farm, replacing meetings with a committee of governing pigs. Through a diminutive boar named Squealer, who is a skilled orator, Napoleon claims credit for the idea of building the windmill, claiming that Snowball was only trying to win animals to his side. The animals work harder with the promise of easier lives with the windmill. When the animals find the windmill collapsed after a violent storm, Napoleon and Squealer persuade the animals that Snowball is trying to sabotage their project, and begin to purge the farm of animals accused by Napoleon of consorting with his old rival. When some animals recall the Battle of the Cowshed, Napoleon, who was not present during the battle, gradually smears Snowball to the point of saying he is a collaborator of Mr. Jones, even dismissing the fact that Snowball was given an award of courage, while falsely representing himself as the main hero of the battle. "Beasts of England" is replaced with "Animal Farm", while an anthem glorifying Napoleon, who is presumably adopting the lifestyle of a man ("Comrade Napoleon"), is composed and sung. Napoleon then conducts a second purge, during which many animals who are alleged to be helping Snowball in plots are executed by Napoleon's dogs, which troubles the rest of the animals. Despite their hardships, the animals are easily pacified by Napoleon's retort that they are better off than they were under Mr. Jones, as well as by the sheep's continual bleating of "four legs good, two legs bad". As Napoleon and Squealer's increasingly humanlike behaviour repeatedly contradicts the Seven Commandments, they secretly rewrite the laws to avoid facing charges.

Mr. Frederick, a neighbouring farmer, attacks the farm, using blasting powder to blow up the restored windmill. Although the animals win the battle, they do so at great cost, as many, including Boxer the workhorse, are wounded. Although he recovers from this, Boxer eventually collapses while working on the windmill due to his extreme age. He is taken away in a knacker's van, and a donkey called Benjamin alerts the animals of this, but Squealer quickly waves off their alarm by persuading the animals that the van had been purchased from the knacker by an animal hospital and that the previous owner's signboard had not been repainted. Squealer subsequently reports Boxer's death and honours him with a festival the following day, while, in truth, Napoleon had engineered the sale of Boxer to the knacker, allowing him and his inner circle to acquire money to buy whisky for themselves, which they used to celebrate the following night.

Years pass, the windmill is rebuilt, and another windmill is constructed, which makes the farm a good amount of income. However, the ideals that Snowball discussed—including stalls with electric lighting, heating, and running water, along with a three-day work week for all animals—are forgotten, with Napoleon now advocating that the happiest animals live simple lives. Snowball has been forgotten, while Boxer is remembered by only few. Many of the animals who participated in the rebellion are dead or old. Mr. Jones is known to have died in an inebriates' home. The pigs now resemble humans: they walk bipedally, carry whips, drink alcohol, and wear clothes. The Seven Commandments are abridged to just one phrase: "All animals are equal, but some animals are more equal than others". The maxim "Four legs good, two legs bad" is similarly changed to "Four legs good, two legs better". Other changes include the Hoof and Horn flag being replaced with a plain green banner and Old Major's skull being reburied.

Napoleon holds a dinner party for the pigs and newly allied human farmers. The other farm animals, who have not been invited, gather at the window to watch. He abolishes the practice of the revolutionary traditions and restores the name "The Manor Farm". The men and pigs start playing cards, flattering and praising each other while cheating at the game. Both Napoleon and Mr. Pilkington, one of the farmers, play the ace of spades at the same time, and both sides begin arguing over who cheated first. When the animals outside look at the pigs and men, they find they have become indistinguishable from one another.
    `,
}, {
    puzzleId: 7,
    name: "Love and Revenge",
    points: 4,
    body: (<div><i>Historical records indicate that it was in the rhythm of a heartbeat.</i></div>),
